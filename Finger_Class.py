...
print("Importing PINKY_THUMB_TIP_TOUCH module...\n")

counter = 0 

#class Finger:

def THUMB_PINKY_TIP_TOUCH(Handdetection_results):
...
def THUMB_RING_TIP_TOUCH(Handdetection_results):
